...
public class HttpService {
	...
	private static int httpThreadCount = 2;// http线程池数量
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		...
		public Thread newThread(Runnable r) {
			Thread tread = new Thread(r, "HttpService #" + mCount.getAndIncrement());
	...
	// ------------------get 请求-----------------------
	public void get(String url, CallBack<? extends Object> callBack) {
		get(url, null, callBack);
	}

	public void get(String url, Parameters params, CallBack<? extends Object> callBack) {
		sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(url, params)), null, callBack);
	}

	public void get(String url, Header[] headers, Parameters params, CallBack<? extends Object> callBack) {
	...
	public Object getSync(String url, Parameters params) {
		HttpUriRequest request = new HttpGet(getUrlWithQueryString(url, params));
		return sendSyncRequest(httpClient, httpContext, request, null);
	}

	public Object getSync(String url, Header[] headers, Parameters params) {
		HttpUriRequest request = new HttpGet(getUrlWithQueryString(url, params));
		if (headers != null)
			request.setHeaders(headers);
		return sendSyncRequest(httpClient, httpContext, request, null);
	...
	// ------------------post请求 -----------------------
	public void post(String url, CallBack<? extends Object> callBack) {
		post(url, null, callBack);
	}

	public void post(String url, Parameters params, CallBack<? extends Object> callBack) {
		post(url, paramsToEntity(params), null, callBack);
	}

	public void post(String url, HttpEntity entity, String contentType,CallBack<? extends Object> callBack) {
		sendRequest(httpClient, httpContext,	addEntityToRequestBase(new HttpPost(url), entity), contentType,	callBack);
	}

	public <T> void post(String url, Header[] headers, Parameters params, String contentType, CallBack<T> callBack) {
	...
	public void post(String url, Header[] headers, HttpEntity entity, String contentType, CallBack<? extends Object> callBack) {
	...
	public Object postSync(String url, Parameters params) {
	...
	public Object postSync(String url, Header[] headers, Parameters params,	String contentType) {
		HttpEntityEnclosingRequestBase request = new HttpPost(url);
		if (params != null)
			request.setEntity(paramsToEntity(params));
		if (headers != null)
	...
	// ------------------put 请求-----------------------
	public void put(String url, CallBack<? extends Object> callBack) {
		put(url, null, callBack);
	}

	public void put(String url, Parameters params, CallBack<? extends Object> callBack) {
		put(url, paramsToEntity(params), null, callBack);
	}

	public void put(String url, HttpEntity entity, String contentType, CallBack<? extends Object> callBack) {
		sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(url), entity), contentType, callBack);
	}

	public void put(String url, Header[] headers, HttpEntity entity, String contentType, CallBack<? extends Object> callBack) {
	...
	public Object putSync(String url, Parameters params) {
	...
	// ------------------delete 请求-----------------------
	public void delete(String url, CallBack<? extends Object> callBack) {
		final HttpDelete delete = new HttpDelete(url);
		sendRequest(httpClient, httpContext, delete, null, callBack);
	}

	public void delete(String url, Header[] headers, CallBack<? extends Object> callBack) {
		final HttpDelete delete = new HttpDelete(url);
		if (headers != null)
	...
	// -------------------- download -------------------------------------
	public HttpHandler<File> download(String url, String target, CallBack<File> callback) {
		return download(url, null, target, false, callback);
	}

	public HttpHandler<File> download(String url, String target, boolean isResume, CallBack<File> callback) {
		return download(url, null, target, isResume, callback);
	}

	public HttpHandler<File> download(String url, Parameters params, String target, CallBack<File> callback) {
		return download(url, params, target, false, callback);
	}

	public HttpHandler<File> download(String url, Parameters params, String target, boolean isResume, CallBack<File> callback) {
	...
	protected <T> void sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, CallBack<T> ajaxCallBack) {
		if (contentType != null) {
	...
	public static String getUrlWithQueryString(String url, Parameters params) {
		if (params != null) {
	...
	private HttpEntity paramsToEntity(Parameters params) {
