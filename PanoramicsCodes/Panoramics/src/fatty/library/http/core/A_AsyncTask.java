...
public abstract class A_AsyncTask<Params, Progress, Result> {
	...
	private static class SerialExecutor implements Executor {
		final A_ArrayDeque<Runnable> mTasks = new A_ArrayDeque<Runnable>();
		Runnable mActive;
	 ...
	 *             {@link A_AsyncTask.Status#RUNNING} or
	 *             {@link A_AsyncTask.Status#FINISHED}.
	 * 
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 * @see #execute(Runnable)
	 */
	public final A_AsyncTask<Params, Progress, Result> execute(Params... params) {
	...
	public final A_AsyncTask<Params, Progress, Result> executeOnExecutor(
	...
	private static class AsyncTaskResult<Data> {
		...
		final A_AsyncTask mTask;
		final Data[] mData;

		AsyncTaskResult(A_AsyncTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
