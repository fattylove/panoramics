 ...
 *
 */
public class HomeNewestService {

	
	public static final int NEWEST_SUCCESS  = 200;
	public static final int ERROR_CODE400 = 400;
	public static final int ERROR_CODE401 = 401;
	
	private Handler handler ;
	
	public HomeNewestService(Handler handler){
	 ...
	 * @param min_id  		最小ID
	 */
	public void newest(String access_token ,String max_timestamp ,String min_timestamp ){
		...
		L.debug(Constant.NETWORK_SERVICE, ServerUrls.NEWEST+"?"+parameters.toString());
		
		new HttpService().get(ServerUrls.NEWEST, parameters	, new CallBack<String>() {

			@Override
			public void onSuccess(String t, int code) {
				super.onSuccess(t, code);
				Message message = new Message();
				message.what = NEWEST_SUCCESS;
				message.obj = t;
