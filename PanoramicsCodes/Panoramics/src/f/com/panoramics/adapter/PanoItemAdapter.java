 ...
 *
 */
public class PanoItemAdapter extends BaseExpandableListAdapter {

	private final LayoutInflater inflater;
	private final Activity activity;

	public ArrayList<MediaEntity> mediaEntities = new ArrayList<MediaEntity>();
	...
	public void destoryReceiver(){
		...
		if(removeMediaReceiver!=null){
			activity.unregisterReceiver(removeMediaReceiver);
		}
	}
	 ...
	 * @param context
	 */
	public PanoItemAdapter(Activity activity) {
	 ...
	 */
	public void setMediaEntities(ArrayList<MediaEntity> groupEntities , FloatHeaderListView floatHeaderListView) {
		this.mediaEntities.addAll(groupEntities);
	...
	public int getChildrenCount(int groupPosition) {
		if(mediaEntities.size() == groupPosition){
			return 0;
		}
		return 1;
	}
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.panoramics_item_group_layout, parent, false);
			groupHolder.headerImageView = (CircleImageView) convertView.findViewById(R.id.headerImageView);
			groupHolder.perNameTextView = (TextView) convertView.findViewById(R.id.perNameTextView);
			...
			groupHolder.headerLayout = (RelativeLayout)convertView.findViewById(R.id.headerLayout);
			...
			groupHolder.headerImageView.setImageBitmap(null);
		}

		final MediaEntity entity = (MediaEntity) getGroup(groupPosition);
		
		ImageLoader.getInstance().displayImage(entity.getAvatar(), groupHolder.headerImageView ,ImageConfig.getHeaderConfig());
		groupHolder.locationTextView.setText(entity.getLocation());
		groupHolder.likeTextView.setText(entity.getLike()+"");
		groupHolder.perNameTextView.setText(entity.getNickname());
		
		groupHolder.headerLayout.setOnClickListener(new OnClickListener() {
		...
		groupHolder.itemLayout.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
			}
		});
		...
		groupHolder.likeImageView.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if(likeState == Constant.UNLIKED){
					...
					PanoItemAdapter.this.notifyDataSetChanged();
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			view = inflater.inflate(R.layout.panoramics_item_child_layout, parent, false);
			holder = new ChildHolder();
			assert view != null;
			holder.item_img = (ImageView) view.findViewById(R.id.item_img);
			holder.progressBar = (ProgressBar)view.findViewById(R.id.progress);
			Drawable draw = activity.getResources().getDrawable(R.drawable.p_myprogressbar_style);
	...
	static class GroupHolder {
		...
		public TextView perNameTextView;
