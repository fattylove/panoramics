 ...
 *
 */
public class FollowerActivity extends BaseFragmentActivity
...
OnRefreshListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.setScreenTag("FollowerActivity");
		setContentView(R.layout.panoramics_follower_layout);
	 ...
	 * @param uid
	 */
	public void currentFollowers(String uid ){
		isLoading = true;
		progressBar.setVisibility(View.VISIBLE);
		FollowService followService = new FollowService(handler);
		followService.followed_by(uid, getPreString("token") ,null,null);
	}
	...
	private Handler handler = new Handler(){
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
			case FollowService.RELATIONSHIP_FOLLOWED_BY:
				switch (msg.arg1) {
				...
				default:
					...
					followListView.onLoadMoreComplete();
					PanoToast.showToast(FollowerActivity.this, "No Internet Connection");
					break;
				}
				break;
			default:
	...
	public void onLoadMore() {
		isLoading = true;
		FollowService followService = new FollowService(handler);
		followService.followed_by(uid, getPreString("token") ,null, lastFollowEntity.getCreateTime() + "");
	}
